...
module.exports = {
	...
	async execute(message, client) {
      ...
      if(!user) { client.database.collection('Users').updateOne({ id: message.author.id }, { $set: { id: message.author.id, guildid: message.guild.id, whitelist: 'off', badges: [], money: '0' }}, { upsert: true }); } 
